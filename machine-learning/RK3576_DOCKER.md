...
- You have already cloned this repository to the board.
...
1. Build a local RKNN machine-learning image from `machine-learning/Dockerfile`
...
```bash
chmod +x machine-learning/deploy_rk3576_docker.sh
./machine-learning/deploy_rk3576_docker.sh \
